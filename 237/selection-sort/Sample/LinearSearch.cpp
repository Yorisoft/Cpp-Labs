// This program demonstrates the searchList function, which performs a 
// linear search on an integer array. (Adapted from Program 8-1.)
#include <iostream>
using namespace std;
...
int main()
{
   ...
   else
   {
      ...
      // the first value of 100 that is present in the array.
